                                ...
                                >
                                    ...
                                    {project.externalLink && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex gap-1 bg-[var(--tertiary)] text-[var(--main)] hover:text-[var(--tertiary)] hover:bg-[var(--main)] hover:border-2 hover:border-[var(--tertiary)] p-3 rounded-4xl transition-colors"
                                        >
                                            <IconLink />
                                            Project Link
                                        </a>
